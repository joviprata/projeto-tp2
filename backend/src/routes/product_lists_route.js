...
router.post('/:listId/items', productListsController.addProductToList); // Add a product to a specific list
router.put('/:listId/items/:productId', productListsController.updateProductFromList); // Update a product in a specific list
router.delete('/:listId/items/:productId', productListsController.deleteProductFromList); // Delete a product from a specific list
